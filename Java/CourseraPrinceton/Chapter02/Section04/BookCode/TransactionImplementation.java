 ...
 *  @author Kevin Wayne
 */
public class TransactionImplementation implements Comparable<TransactionImplementation> {
     ...
     */
    public TransactionImplementation(String who, Date when, double amount) {
     ...
     */
    public int compareTo(TransactionImplementation that) {
    ...
    public boolean equals(Object other) {
        ...
        TransactionImplementation that = (TransactionImplementation) other;
     ...
     */
    public static class WhoOrder implements Comparator<TransactionImplementation> {

        @Override
        public int compare(TransactionImplementation v, TransactionImplementation w) {
     ...
     */
    public static class WhenOrder implements Comparator<TransactionImplementation> {
     ...
     * Compares two transactions by amount.
     */
    public static class HowMuchOrder implements Comparator<TransactionImplementation> {
    ...
    public static void main(String[] args) {
        TransactionImplementation[] a = new TransactionImplementation[4];
        a[0] = new TransactionImplementation("Turing   6/17/1990  644.08");
        a[1] = new TransactionImplementation("Tarjan   3/26/2002 4121.85");
        a[2] = new TransactionImplementation("Knuth    6/14/1999  288.34");
        a[3] = new TransactionImplementation("Dijkstra 8/22/2007 2678.40");
        ...
        Arrays.sort(a, new TransactionImplementation.WhenOrder());
        for (int i = 0; i < a.length; i++)
            StdOut.println(a[i]);
        StdOut.println();

        StdOut.println("Sort by customer");
        Arrays.sort(a, new TransactionImplementation.WhoOrder());
        for (int i = 0; i < a.length; i++)
            StdOut.println(a[i]);
        StdOut.println();

        StdOut.println("Sort by amount");
        Arrays.sort(a, new TransactionImplementation.HowMuchOrder());
        for (int i = 0; i < a.length; i++)
            StdOut.println(a[i]);
        StdOut.println();
    }
